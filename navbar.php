<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Promed</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="index.php">Nieuw bericht</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="edit.php">Lijst met berichten</a></li>
          </ul>
        </li>
        <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="index.php">Gebruiker toevoegen</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="edit.php">Lijst gebruikers</a></li>
        </ul>
      </ul>
      </li>
